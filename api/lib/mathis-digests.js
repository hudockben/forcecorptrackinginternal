...
async function payrollDigest(c) {
  ...
  return {
    ...
    employees: capList((m.employees || []).map(e => ({
      ...
      // Inside workHours, not beside it — see the limits above. Sent per person
      // because "how much of his fortnight was driving" is a question about one
      // man, and a crew total cannot answer it.
      truckHours:    round2(e.truckHours),
