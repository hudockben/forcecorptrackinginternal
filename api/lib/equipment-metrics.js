'use strict';
/**
 * What a piece of equipment ran, and what that came to.
 *
 ...
 *
 * Nothing here is a second opinion about money. The equipment total on a job
 * is ALREADY inside that job's actual cost — daily rows are what actual cost
 * is made of. This breaks that number down by machine; it never adds to it.
...
module.exports = { rowEquipCost, equipmentUsage };
