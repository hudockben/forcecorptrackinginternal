...
MUT=[
 ...
 ("warning: back to name-only check","payroll.html",
  "      if ((Number(r && r.equip_hours) || 0) <= 0) return false;\n      const said",
  "      const said","scripts/test-haul-unpriced-warning.js"),
 ...
 ("sweep: ignore the stored exemption and re-haul the row","api/timesheet-entries.js",
  ...
  "scripts/test-haul-row-rate.js"),
 ("sweep: stop clearing a stale haul_hours","api/timesheet-entries.js",
 ...
 ("resplit: hand every row back as a deliberate 'not a haul'","api/timesheet-entries.js",
  "            : r.haul_exempt === true ? { is_haul: false } : null),",
  "            : { is_haul: false }),","scripts/test-haul-row-rate.js"),
